...
def train(args):
    ...
    # load dataset
    train_dataset = load_data(dataset_dir=args.train_path)
    ...
    # tokenizing dataset
    tokenized_train, token_num = tokenized_dataset(train_dataset, tokenizer)
    ...
    model.resize_token_embeddings(tokenizer.vocab_size + token_num)
    model.to(device)
